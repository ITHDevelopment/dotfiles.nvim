...
--local vcs = require("nv-galaxyline.providers.vcs")
--local fileinfo = require("nv-galaxyline.providers.fileinfo")
--local extension = require("nv-galaxyline.providers.extension")
--local buffer = require("nv-galaxyline.providers.buffer")
--local vimode = require("nv-galaxyline.providers.vimode")
